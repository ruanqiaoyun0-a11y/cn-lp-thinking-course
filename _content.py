...
<div class="section-header">
  ...
  <p class="duration">⏱ 学习时长：18-22 分钟 ｜ 🏆 含终极考核（填空 + 情境演练）</p>
</div>
...
<div class="reflect-box">
  ...
  再想想：如果家长说「我家孩子成绩挺好的，不用学这个」，你会先共情哪一句，再挑哪个角度说透？<strong>想清楚了，再回到上面的情境演练，把答案写出来。</strong>
</div>
'''
