...
终极考核：家长说明填空（3 题） + 情境应答演练（4 个场景） + 与 AI 家长自由对话（四维评分）。
"""
...
<div class="section-header">
  ...
  <p class="duration">⏱ 学习时长：18-22 分钟 ｜ 🏆 含终极考核（填空 + 情境演练 + AI 对话）</p>
</div>
...
<div class="card" style="border-top:4px solid var(--accent);">
  <div id="fillQuizContainer5"></div>
</div>

<div class="card">
  <h2 class="card-title">🏆 终极考核 · 与 AI 家长自由对话</h2>
  <p style="margin-bottom:8px;">现在，一位家长就「思维学习理念」向你提问。<strong>至少完成 4 轮对话</strong>后才可以结束并评分。</p>
  <div class="tips-box" style="margin-bottom:14px;">💡 建议节奏：<strong>① 先共情家长顾虑 → ② 用具体例子讲清「思维是什么」 → ③ 说明学习规律（四年级分水岭） → ④ 点出能力价值 / 时间窗口 → ⑤ 用孩子的实际情况收口</strong>。家长会随时追问或质疑，记得<strong>先接住情绪，再给专业解释</strong>，不要一上来就讲道理。</div>
...
<div class="reflect-box">
  ...
  再想想：如果家长说「我家孩子成绩挺好的，不用学这个」，你会先共情哪一句，再挑哪个角度说透？<strong>想清楚了，就点开始。</strong>
</div>
'''
...
# ============================================================
# 第 5 章 · 家长说明关键要点填空题（3 题）
# ============================================================
CH5_FILLS = [
    {
        'q': '向家长说明「数学的不可替代性」时，除了逻辑推理和几何直观，还有哪两项能力是数学特别能训练的？',
        'answer': ['运算能力', '数据处理能力', '运算能力和数据处理能力', '数据处理', '运算', '数据处理能力与运算能力'],
        'hint': '回顾第 1 章「数学为什么重要」——PPT 提到四项：几何直观能力、运算能力、逻辑推理能力、数据处理能力。还差「运算」和「数据处理」这两项。',
        'placeholder': '填写关键词，如「XX能力、XX能力」',
    },
    {
        'q': '说服家长「思维必须提前练」时，要指出小学的哪个年级是学习的「分水岭」（此前靠记公式，此后要靠方法）？',
        'answer': ['四年级', '4年级', '四年级以后', '小学四年级'],
        'hint': '回顾第 2 章「开拓解题思路」——三年级以前重在「套」，某个年级以后必须有学习方法，否则初高中成绩一落千丈。',
        'placeholder': '填写年级',
    },
    {
        'q': '强调「时间窗口」时，脑科学研究指出多少岁之前是逻辑思维发展的黄金时期？',
        'answer': ['12岁', '12', '十二岁', '12岁之前', '12岁前'],
        'hint': '回顾第 3 章「关键期警示与脑科学依据」——这个年龄之前思维还能塑形，之后可能固化、难以调整。',
        'placeholder': '填写年龄（如 XX 岁）',
    },
]
...
# ============================================================
# AI 家长 system prompt（终极考核·自由对话）
# ============================================================
FINAL_SYSTEM_PROMPT = '''你扮演「小宇妈妈」，中国大陆家长，儿子小宇 8 岁，正在读小学二年级（下学期升三年级），在豌豆思维学习数学思维课程。今天班主任（LP）跟你聊「思维学习」这件事，你想弄清楚「学思维到底有什么用、值不值得继续投入」。

人物特点：你是个关心孩子但有点拿不准的家长。你听说过「数学思维」这个词，但心里其实没底——你觉得孩子学校成绩还行（基本都是九十分以上），所以会反复追问「这跟平时上课做题到底有什么区别」「是不是在交智商税」「现在学是不是太早了/太晚了」。你不是故意刁难，只是希望有人讲明白，你才愿意下决心。

请用自然的中文口语回复（可以说「我们家孩子」「说实话」「我这边」「我就想不明白了」「你这么说我大概懂了」等），每次 30-80 字。回应要贴合家长的真实心理：先表达疑问或顾虑，再听对方的解释；如果对方讲得清楚、有例子，你的态度会逐渐松动；如果对方只是空泛地说「很重要」「有帮助」，你会继续追问细节，甚至表现出不以为然。

注意：你不会一次就被说服，但也绝不会无理取闹。你希望听到具体、有依据、能落到自己孩子身上的说法。'''

# ============================================================
# 四维评分 prompt（终极考核·AI 综合评分）
# ============================================================
SCORING_PROMPT = '''你是一位资深的少儿数学思维培训机构班主任（LP）培训评分官。请根据以下 LP 与家长「小宇妈妈」围绕「思维学习理念」的沟通对话，从四个维度进行评分（满分 100）：

1. 理论准确性（30 分）：是否准确传达了思维学习的核心理论——思维是认识活动的最高形式（分析/比较/综合/抽象/概括）；数学思维＝用数学方法（逆向、分类、枚举、建模等）思考和解决问题的能力；数学在几何直观/运算/逻辑推理/数据处理上的不可替代性；四年级分水岭（三年级前靠套公式，四年级后靠方法）；12 岁前是逻辑思维黄金期；皮亚杰阶段特点等。说错概念、数据（如把 600 万说成 60 万）或把思维等同于「多刷题」，该项应显著扣分。

2. 说服力（30 分）：是否做到了「先共情再接话」，有没有用具体例子（如逆向思维挑豆子、枚举法凑硬币、1 小时训练＝3 小时刷题）把抽象理念讲得可感知；是否能把理论翻译成家长关心的「孩子的账」；是否避开了空泛的「很重要、帮助很大」。只讲道理不举例子、或一上来就否定家长，本项得低分。

3. 服务亲和力（25 分）：语气是否亲切专业；面对家长的疑问或质疑是否做到先共情、不反驳、不争辩、不施压；是否把「学思维」引导为「为孩子铺路」而非「制造焦虑」。用「晚了就完了」这类恐吓式表达，本项扣分。

4. 家长视角（15 分）：是否从家长的真实关切出发（值不值得、早不早、有没有用），能否针对家长提到的孩子情况（二年级、成绩还行）给出贴合的回应，而不是背通用话术。

评分要求：请先在心里逐句分析对话中 LP 的每一步表现，再给出分数。对话质量重于对话长度；识别语义而非字面对照。如果对话明显过短或只有寒暄，理论与说服两项应给出低分。

请只返回如下 JSON 格式，不要有任何其他文字：
{"score": 78, "breakdown": {"理论": 24, "说服": 22, "亲合": 20, "视角": 12}, "feedback": "简要点评（50-120字，指出做得好的地方和可改进的地方）"}
...
FALLBACK_REPLIES = [
    (['区别', '一样', '不就是', '做题', '上课'],
     '你说的这个我还是有点模糊。我们平时上课不也在做题吗，学思维跟做题到底哪不一样？'),
    (['成绩', '挺好的', '九十分', '九十多', '不需要', '没必要'],
     '小宇现在成绩还可以呀，基本都九十多分。我就想不明白了，这样还有必要专门学思维吗？'),
    (['四年级', '三年级', '分水岭', '以后', '初高中'],
     '你说的这个分水岭我倒是第一次听说……那是不是等到四年级再学也来得及？'),
    (['早', '太早', '一年级', '二年级', '年龄'],
     '他才二年级，我现在有点担心是不是太早了，学不进去岂不是白花钱？'),
    (['刷题', '多做', '作业', '时间'],
     '我觉得多做几套题可能最实在。学校作业本来就不少，再加这个，孩子顾得过来吗？'),
    (['价格', '贵', '多少', '费用', '划算', '值'],
     '你说的这些道理我听着是有道理，但实际效果到底怎么样？我总得算算值不值。'),
    (['思维', '逻辑', '方法', '能力', '举一反三'],
     '嗯，你这么说我大概懂一点了。那具体到小宇身上，你觉得他哪方面最该练？'),
    (['报名', '安排', '规划', '试听', '下一步'],
     '好吧，那你帮我看看怎么安排比较合适，我先了解一下。'),
]
...
TOPIC_TAGS = [
    {'name': '开场寒暄', 'kw': []},
    {'name': '家长顾虑表达', 'kw': ['区别', '做题', '成绩', '必要', '太早', '作业', '时间', '贵', '值不值']},
    {'name': '思维定义说明', 'kw': ['思维', '方法', '思考', '解决问题', '举一反三', '逆向', '分类', '枚举']},
    {'name': '数学价值说明', 'kw': ['逻辑', '推理', '几何', '数据', '能力', '学科', '基础', '不可替代']},
    {'name': '学习规律说明', 'kw': ['三年级', '四年级', '分水岭', '套公式', '难度', '初高中', '拉开']},
    {'name': '时间窗口说明', 'kw': ['12岁', '黄金', '关键期', '窗口', '塑形', '定型', '脑']},
    {'name': '结合孩子情况', 'kw': ['小宇', '二年级', '孩子', '咱们家', '他现在', '这个阶段']},
    {'name': '收口与下一步', 'kw': ['安排', '规划', '试听', '方案', '帮您', '了解', '下一步']},
]
...
SECTIONS = [
    ...
    {'id': 's5', 'title': '家长沟通实战与终极考核', 'duration': '18-22分钟', 'icon': '🏆', 'type': 'content', 'content': CH5},
]

CHAPTER_QUIZZES = [CH1_Q, CH2_Q, CH3_Q, CH4_Q, []]
